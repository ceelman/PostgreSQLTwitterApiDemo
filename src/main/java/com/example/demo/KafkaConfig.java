...
public class KafkaConfig {
    ...
    public KafkaTemplate<String, SimpleModel> kafkaTemplate() {
        return new KafkaTemplate<String, SimpleModel>(producerFactory());
    }
    ...
    public ConsumerFactory<String, SimpleModel> consumerFactory() {
        ...
        return new DefaultKafkaConsumerFactory<String, SimpleModel>(config, new StringDeserializer(), new JsonDeserializer<>(SimpleModel.class));
    }
